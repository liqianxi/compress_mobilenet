...
def MobileNetV2(
    ...
    **kwargs,
    ...
    x = _inverted_res_block(
        x, filters=32, alpha=alpha, stride=1, expansion=6, block_id=2
    )

    x = _inverted_res_block(
        x, filters=64, alpha=alpha, stride=2, expansion=6, block_id=3
    )


    x = _inverted_res_block(
        x, filters=96, alpha=alpha, stride=1, expansion=6, block_id=4
    )


    x = _inverted_res_block(
        x, filters=160, alpha=alpha, stride=2, expansion=6, block_id=5
    )
    '''
    x = _inverted_res_block(
